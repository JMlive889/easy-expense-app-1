import { Upload, Sparkles, Target, ShieldCheck, ClipboardList, Bell, Eye, Shield, Layers, Flag, MousePointerClick, ListChecks, UserCheck, Lock, FileText, Users, Smartphone, Download, Zap, RefreshCw, FileSpreadsheet, FileDown, Filter, CheckCircle, Plug, Database } from 'lucide-react';
          ...
          <section className="relative py-16 mt-16 dark:bg-secondary-dark bg-gray-50 rounded-3xl">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-16 max-w-4xl mx-auto">
                ...
                <p className="text-lg md:text-xl dark:text-gray-300 text-gray-700 leading-relaxed">
                  Get a sneak peek in this overview video of our integration-ready architecture. See how hooks enable easy connections to the upcoming timetracking app and main accounting system, pulling concrete data for unmatched accuracy. Learn about future plugins and AI modules—position your team for a fully connected ecosystem. Stay ahead with transparent, scalable integrations built for growth.
                </p>
              </div>
            </div>
          </section>
